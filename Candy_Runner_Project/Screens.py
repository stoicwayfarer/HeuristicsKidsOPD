...
class StartScreen(BaseScreen):
    def __init__(self, width, height, audio_manager):
        ...
        self.load_background("Images&Sprites/Start_screen.png")
        self.result = False
        self.audio_manager = audio_manager
    ...
    def draw(self):
        ...
        self.screen.blit(title_shadow, (535 + shadow_offset, 150 + shadow_offset))
        self.screen.blit(self.title_text, (535, 150))
...
class FinalScreen(BaseScreen):
    def __init__(self, width, height, audio_manager):
        pygame.display.set_caption("Candy Runner")
        super().__init__(width, height)
        self.load_background("Images&Sprites/Final_screen.png")
        self.result = None
        self.audio_manager = audio_manager
        self.sound_played = False
        ...
        self.title_text = self.title_font.render("Спасибо за прохождение игры!", True, BLACK)
        self.devs_text = self.devs_font.render("Разработчики: Постникова Марина и Кретов Дмитрий", True, self.BLACK)

        button_normal = (196, 255, 249, 200) 
        button_hover = (196, 255, 249, 255) 
        button_text = BLACK
