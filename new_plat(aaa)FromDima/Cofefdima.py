...
def main():
    screen_manager = ScreenManager()  # Создаем экземпляр менеджера экранов
    audio_manager = AudioManager()
    
    if not screen_manager.start_screen():  # Используем метод start_screen
        return 
    ...
    while running:
        ...
        screen.blit(map.map_surface, camera.apply_rect(map.map_surface.get_rect()))
